<x-html lang="{{ app()->getLocale() }}">
    <x-slot:head>
        ...
        <meta name="keywords" content="search, products, results">
        <meta property="og:title" content="Search Results - MyShop">
        <meta name="description" content="Search results and faceted filters to help customers find products quickly.">
        <meta property="og:description"
            content="Search results and faceted filters to help customers find products quickly.">
                    ...
                    <div style="flex-wrap: wrap" class="d-flex justify-content-center ">
                        @foreach ($products as $product)
                            <article
                                ...
                                <img style="min-width: 5rem; max-width: 5rem; object-fit: cover; margin-right: 1rem"
                                ...
                                <a id="a-9" href="{{ route('products.show', [$product->id]) }}" class=" btn">
                                    {{ __('labels.VIEW') }}
                                </a>
                            </article>
                        @endforeach
