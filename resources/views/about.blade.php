<x-html lang="{{ app()->getLocale() }}">
    <x-slot:head>
        ...
        <meta name="keywords" content="about, trust, company">
        <meta property="og:title" content="About Us - MyShop">
        <meta name="description" content="Learn about MyShop, our values, trust signals and commitment to customers.">
        <meta property="og:description"
            content="Learn about MyShop, our values, trust signals and commitment to customers.">
        ...
        <div style="flex: 1; min-height: 100vh; background-color: var(--background); padding: 2vw 4vw"
            ...
            <main class="d-flex flex-column justify-content-start align-items-stretch ">
                <section class="d-flex flex-column justify-content-start align-items-stretch container">
                    <h1>
                        {{ __('about.ABOUT_MYSHOP') }}
                    </h1>
                    <p>
                        {{ __('about.ABOUT_2') }}
                    </p>
                    <h2>
                        {{ __('about.WHY_SHOP_WITH_US') }}
                    </h2>
                    <p>
                        {{ __('about.ABOUT_3') }}
                    </p>
