<x-admin>
    ...
    <div class="d-flex justify-content-start align-items-stretch" style="flex: 1;">
        <div class="accordion mb-3" id="accordion-HQO3H" style="flex: 1;">
            <div class=\accordion-item">
                ...
                <div id="collapse-HQO3H" class="accordion-collapse collapse show" data-bs-parent="#accordion-HQO3H">
            ...
            <div class=\accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collpase-HQO3H-1" aria-expanded="false" aria-controls="collapse-HQO3H-1">

                    </button>
                </h2>
                <div id="collapse-HQO3H" class="accordion-collapse" data-bs-parent="#accordion-HQO3H">
