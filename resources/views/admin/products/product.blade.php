<x-admin>
    ...
    <div class="d-flex justify-content-start align-items-stretch" style="flex: 1;">
        <div class="accordion mb-3" id="accordion-exN17" style="flex: 1;">
            <div class=\accordion-item">
                ...
                <div id="collapse-exN17" class="accordion-collapse collapse show" data-bs-parent="#accordion-exN17">
            ...
            <div class=\accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collpase-exN17-1" aria-expanded="false" aria-controls="collapse-exN17-1">

                    </button>
                </h2>
                <div id="collapse-exN17" class="accordion-collapse" data-bs-parent="#accordion-exN17">
