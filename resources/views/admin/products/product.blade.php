<x-admin>
    ...
    <div class="d-flex justify-content-start align-items-stretch" style="flex: 1;">
        <div class="accordion mb-3" id="accordion-5dxAW" style="flex: 1;">
            <div class=\accordion-item">
                ...
                <div id="collapse-5dxAW" class="accordion-collapse collapse show" data-bs-parent="#accordion-5dxAW">
            ...
            <div class=\accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collpase-5dxAW-1" aria-expanded="false" aria-controls="collapse-5dxAW-1">

                    </button>
                </h2>
                <div id="collapse-5dxAW" class="accordion-collapse" data-bs-parent="#accordion-5dxAW">
