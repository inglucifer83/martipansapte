<x-admin>
    ...
    <div class="d-flex justify-content-start align-items-stretch" style="flex: 1;">
        <div class="accordion mb-3" id="accordion-Y1m8O" style="flex: 1;">
            <div class=\accordion-item">
                ...
                <div id="collapse-Y1m8O" class="accordion-collapse collapse show" data-bs-parent="#accordion-Y1m8O">
            ...
            <div class=\accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collpase-Y1m8O-1" aria-expanded="false" aria-controls="collapse-Y1m8O-1">

                    </button>
                </h2>
                <div id="collapse-Y1m8O" class="accordion-collapse" data-bs-parent="#accordion-Y1m8O">
