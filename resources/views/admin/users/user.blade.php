<x-admin>
    ...
    <div class="d-flex justify-content-start align-items-stretch" style="flex: 1;">
        <div class="accordion mb-3" id="collpase-container-vqa98" style="flex: 1;">
            <div class=\accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collpase-vqa98" aria-expanded="true" aria-controls="collapse-vqa98">

                    </button>
                </h2>
                <div id="collapse-vqa98" class="accordion-collapse collapse show"
                    data-bs-parent="#collpase-container-vqa98">
