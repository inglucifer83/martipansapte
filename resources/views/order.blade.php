<x-html lang="{{ app()->getLocale() }}">
    <x-slot:head>
        ...
        <meta name="keywords" content="order, details, confirmation">
        <meta property="og:title" content="Order Details - MyShop">
        <meta name="description"
            content="Detailed order confirmation page including items, shipping, payment and status timeline for clarity.">
        <meta property="og:description"
            content="Detailed order confirmation page including items, shipping, payment and status timeline for clarity.">
        <link rel="canonical" href="{{ url('orders/show') }}" />
        <meta property="og:site_name" content="PrettyShop">
        <meta property="og:url" content="{{ url('orders/show') }}">
        <meta charset="utf-8">
