<x-html lang="{{ app()->getLocale() }}">
    <x-slot:head>
        ...
        <meta name="keywords" content="product, detail, buy">
        <meta property="og:title" content="Product - MyShop">
        <meta name="description"
            content="Product detail page with images, variants, stock and reviews to drive conversion.">
        <meta property="og:description"
            content="Product detail page with images, variants, stock and reviews to drive conversion.">
        <link rel="canonical" href="{{ url('products/show') }}" />
        <meta property="og:site_name" content="PrettyShop">
        <meta property="og:url" content="{{ url('products/show') }}">
        <meta charset="utf-8">
    ...
    <div style="width: 100vw; min-height: 100vh" class="d-flex flex-column ">
        ...
        <div style="flex: 1; min-height: 100vh; background-color: var(--background); padding: 2vw 4vw"
            ...
            <main class="d-flex flex-column justify-content-start align-items-stretch ">
                <section class="d-flex justify-content-start align-items-start container">
                    <div style="min-width: 40vw; margin-right: 1rem"
                        class="d-flex flex-column justify-content-start align-items-stretch ">
                        <img style="width: 100%; min-height: 30vh; object-fit: cover"
                            src="{{ $product->featured_image }}" alt="{{ $product->name }}">
                    </div>
                    <div style="flex: 1" class="d-flex flex-column justify-content-start align-items-stretch ">
                        <h1>
                            {{ $product->name }}
                        </h1>
                ...
                <section style="padding-top: 1.5rem"
                    ...
                    <div style="flex-wrap: wrap" class="d-flex justify-content-center ">
                        @foreach ($reviews as $review)
                            <article
                                style="border-bottom: 1px solid rgba(0,0,0,0.05); padding-top: 0.5rem; padding-bottom: 0.5rem"
                                class="d-flex flex-column justify-content-start align-items-stretch ">
                                <div class="d-flex justify-content-start align-items-center ">
                                    <strong>
                                        {{ $review->title }}
