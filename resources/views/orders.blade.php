<x-html lang="{{ app()->getLocale() }}">
    <x-slot:head>
        ...
        <meta name="keywords" content="orders, history, account">
        <meta property="og:title" content="Your Orders - MyShop">
        <meta name="description"
            content="Order history showing past orders, statuses and quick access to details for reorders and support.">
        <meta property="og:description"
            content="Order history showing past orders, statuses and quick access to details for reorders and support.">
        <link rel="canonical" href="{{ url('orders') }}" />
        <meta property="og:site_name" content="PrettyShop">
        <meta property="og:url" content="{{ url('orders') }}">
        <meta charset="utf-8">
                    ...
                    @foreach ($orders as $order)
                        <article
                            ...
                            <div class="d-flex justify-content-end align-items-center ">
                                ...
                                <a id="a-9" href="{{ route('orders.show', [$order->id]) }}" class=" btn">
                                    {{ __('orders.DETAILS') }}
                                </a>
                            </div>
                        </article>
