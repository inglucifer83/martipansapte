import {
  App, Stack, CfnOutput, RemovalPolicy, Tags, Duration, SecretValue, CfnParameter, Aws,
  aws_ec2 as ec2,
  aws_iam as iam,
...
class MartipansapteTestStack extends Stack {
  constructor(scope, id, props = {}) {
    ...
    const ami = ec2.MachineImage.genericLinux({'eu-central-1': 'ami-015cbce10f839bd0c'});
		const dbPort = 3306;
...
const app = new App();
new MartipansapteTestStack(app, 'MartipansapteTestStack', {
  env: {
    region: 'eu-central-1'
  }
});